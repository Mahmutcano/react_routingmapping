...
export default function SideList(props) {
  ...
  // Route Select Friends
  const handleRouteMap = useCallback(
    (e) => {
      if (addFriends) {
        const item = addFriends.find((i) => +i.latitude === +e.target.id)
        console.log(item)
        dispatch({
  ...
  return (
    <>
      <Transition.Root show={props.open} as={Fragment}>
        <Dialog as="div" className="relative z-[10000]" onClose={props.setOpen}>
          <Transition.Child
            as={Fragment}
                  ...
                  <Dialog.Panel className="pointer-events-auto w-screen max-w-md">
                    <div className="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                      ...
                      <div className="border-t border-gray-200 py-6 px-4 sm:px-6">
                        ...
                        <div className="mt-6 flex border-t justify-center text-center text-lg text-gray-500">
                          <p>
                            ya da
                            <br />
                            <button
